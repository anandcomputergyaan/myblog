                ...
                <div class="row">
                    <div class="col-md-12">
                        <form>
                            ...
                            <span>Or Call <a href="#">9555335200</a></span>
                ...
                <div class="col-lg-9 col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 p-0">
                            <img src="<?php echo base_url('assets/images/image-1.jpg');?>" alt="The Pulpit Rock">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row box-1" data-aos="fade-up" data-aos-duration="500">
                ...
                <div class="col-lg-9 col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 p-0">
                            <img src="<?php echo base_url('assets/images/image-2.jpg');?>" alt="The Pulpit Rock">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row box-1" data-aos="fade-up" data-aos-duration="500">
                ...
                <div class="col-lg-9 col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-4 p-0">
                            <img src="<?php echo base_url('assets/images/image-3.jpg');?>" alt="The Pulpit Rock">
                        </div>
                    </div>
                </div>
            </div>
       ...
       Grid row
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-4 col-4"><img src="<?php echo base_url('assets/images/client-logo-1.jpg')?>" class="img-fluid" alt=""></div>
                    <div class="col-md-4 col-4"><img src="<?php echo base_url('assets/images/client-logo-2.jpg')?>" class="img-fluid" alt=""></div>
                    <div class="col-md-4 col-4"><img src="<?php echo base_url('assets/images/client-logo-3.jpg')?>" class="img-fluid" alt=""></div>
                    <div class="col-md-4 col-4"><img src="<?php echo base_url('assets/images/client-logo-6.jpg')?>" class="img-fluid" alt=""></div>
                    <div class="col-md-4 col-4"><img src="<?php echo base_url('assets/images/client-logo-4.jpg')?>" class="img-fluid" alt=""></div>
                    <div class="col-md-4 col-4"><img src="<?php echo base_url('assets/images/client-logo-5.jpg')?>" class="img-fluid" alt=""></div>
                </div>
            </div>
        </div>
        /. Grid row
                    ...
                    <div class="col-lg-9 col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="blog-list">
                                    <a href="blog_single.html" class="image">
                                        <img src="<?php echo base_url()?>assets/images/blog-img-1.png" alt="" />
                                    </a>
                            ...
                            <div class="col-md-6">
                                <div class="blog-list">
                                    <a href="blog_single.html" class="image">
                                        <img src="<?php echo base_url()?>assets/images/blog-img-2.png" alt="" />
                                    </a>
                                    <div class="bottom-details">
